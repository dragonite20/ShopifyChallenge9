...
async function handleGetRequest(req, res) {
  ...
  try {
    const {
      userId
    } = jsonwebtoken__WEBPACK_IMPORTED_MODULE_1___default.a.verify(req.headers.authorization, "dhfudhsfuhsdfhsud");
...
async function connectDb() {
  ...
  const db = await mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.connect("mongodb+srv://mesbahrafin:mVpOOB2RdCTnNsvW@cluster0-exduw.mongodb.net/test?retryWrites=true&w=majority", {
    useCreateIndex: true,
...
module.exports = __webpack_require__(/*! /mnt/c/Users/mesba/Desktop/MERN_Store/MERN-Store/pages/api/account.js */"./pages/api/account.js");
